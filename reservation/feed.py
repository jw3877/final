...
class ResourceFeed(Feed):
  ...
  def item_description(self, obj):
    ...
    return 'A {0} minute reservation that begins at {1} and ends at {2}.'.format(obj.duration(), obj.start_time.strftime(date_format), obj.end_time.strftime(date_format))
